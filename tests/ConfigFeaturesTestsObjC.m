...
- (void)setUp {
  ...
  self.expectedFiles = @[
    @"CONFIGConfig.h", @"CONFIGConfig.m", @"CONFIGAdvanced.h", @"CONFIGAdvanced.m",
    @"CONFIGConfig+File.h", @"CONFIGConfig+File.m", @"CONFIGEnumeratedStringEnum.h",
    @"CONFIGEnumeratedStringEnum.m", @"CONFIGFeature.h", @"CONFIGFeature.m",
    @"CONFIGFeatureNameEnum.h", @"CONFIGFeatureNameEnum.m", @"CONFIGFeatures.h",
    @"CONFIGFeatures.m", @"configFeaturesHeaders.h", @"CONFIGUserRightsEnum.h",
...
- (void)setUpNamespaced {
  ...
  self.expectedFiles = @[
    ...
    @"CONFIGEnumeratedStringEnum.m", @"CONFIGFeature.h", @"CONFIGFeature.m",
    @"CONFIGFeatureNameEnum.h", @"CONFIGFeatureNameEnum.m", @"CONFIGFeatures.h",
    @"CONFIGFeatures.m", @"configFeaturesNamespaced.h", @"CONFIGUserRightsEnum.h",
    @"CONFIGUserRightsEnum.m"
  ];
  [self helpSetUp];
}
...
- (void)setUpPrefix {
  ...
  self.expectedFiles = @[
    @"TESTConfig.h", @"TESTConfig.m", @"TESTAdvanced.h", @"TESTAdvanced.m", @"TESTConfig+File.h",
    @"TESTConfig+File.m", @"TESTEnumeratedStringEnum.h", @"TESTEnumeratedStringEnum.m",
    @"TESTFeature.h", @"TESTFeature.m", @"TESTFeatureNameEnum.h", @"TESTFeatureNameEnum.m",
    @"TESTFeatures.h", @"TESTFeatures.m", @"configFeatures.h", @"TESTUserRightsEnum.h",
...
- (void)assertParsedXML:(id)rootNode {
  ...
  XCTAssertTrue(
      [[rootNode valueForKey:@"userRights"] isEqualToNumber:@3]);  // isEqualToString:@"User"]);
}
