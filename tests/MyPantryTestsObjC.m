...
- (void)setUp {
  ...
  self.expectedFiles = @[
    @"MyPantry.h", @"PFoodGroupTypeEnum.h", @"PFoodGroupTypeEnum.m", @"PFoodItemType.h",
    @"PFoodItemType.m", @"PPantryType.h", @"PPantryType.m", @"PPantryType+File.h",
    @"PPantryType+File.m", @"PShelfType.h", @"PShelfType.m"
  ];
