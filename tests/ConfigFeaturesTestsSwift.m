...
- (void)setUp {
  ...
  self.expectedFiles = @[
    @"libxml-bridging-header.h", @"CONFIGConfig.swift", @"CONFIGAdvanced.swift",
    @"CONFIGConfig+File.swift", @"CONFIGEnumeratedStringEnum.swift", @"CONFIGFeature.swift",
    @"CONFIGFeatureNameEnum.swift", @"CONFIGFeatures.swift", @"CONFIGUserRightsEnum.swift"
  ];
...
- (void)setUpPrefix {
  ...
  self.expectedFiles = @[
    @"libxml-bridging-header.h", @"TESTConfig.swift", @"TESTAdvanced.swift",
    @"TESTConfig+File.swift", @"TESTEnumeratedStringEnum.swift", @"TESTFeature.swift",
    @"TESTFeatureNameEnum.swift", @"TESTFeatures.swift", @"TESTUserRightsEnum.swift"
  ];
...
- (void)assertParsedXML:(id)rootNode {
  ...
  XCTAssertTrue([[self reflect:features[0] numberForKey:@"identifier"]
      isEqualToNumber:@1]);  // isEqualToString:@"Main"]);
  XCTAssertTrue([[self reflect:features[1] numberForKey:@"identifier"]
      isEqualToNumber:@2]);  // isEqualToString:@"Networing"]);
  XCTAssertTrue([[self reflect:features[2] numberForKey:@"identifier"]
      isEqualToNumber:@3]);  // isEqualToString:@"OfficeSuite"]);
  XCTAssertTrue([[self reflect:features[3] numberForKey:@"identifier"]
      isEqualToNumber:@5]);  // isEqualToString:@"TrafficInformation"]);
  XCTAssertTrue([[self reflect:features[4] numberForKey:@"identifier"]
      isEqualToNumber:@6]);  // isEqualToString:@"RSS"]);
  XCTAssertTrue([[self reflect:features[5] numberForKey:@"identifier"]
      isEqualToNumber:@8]);  // isEqualToString:@"PersonalHomepage"]);
  XCTAssertTrue([[self reflect:rootNode numberForKey:@"userRights"]
      isEqualToNumber:@3]);  // isEqualToString:@"User"]);
}
