...
- (void)setUp {
  ...
  self.expectedFiles = @[
    @"WLFavdef.h", @"WLFavdef.m", @"WLFG.h", @"WLFG.m", @"WLFG+File.h", @"WLFG+File.m",
    @"WLGroupdef.h", @"WLGroupdef.m", @"WLDescription.m", @"WLDescription.h", @"weblinks.h"
  ];
...
- (void)assertParsedXML:(id)rootNode {
  ...
  XCTAssertTrue([[childGroups[0] valueForKeyPath:@"elementDescription.value"]
      isEqualToString:@"Group description"]);
