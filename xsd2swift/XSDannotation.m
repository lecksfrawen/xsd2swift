...
#import "xsd2swift/XSDannotation.h"
...
- (id)initWithNode:(NSXMLElement *)node schema:(XSDschema *)schema {
  ...
  if (self) {
    self.identifier = [[XMLUtils node:node stringAttribute:@"id"]
        stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
    self.appInfo = [[XMLUtils node:node childWithName:@"appinfo"].stringValue
        stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
    self.documentation = [[XMLUtils node:node childWithName:@"documentation"].stringValue
        stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
