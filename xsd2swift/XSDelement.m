...
- (id)initWithNode:(NSXMLElement*)node
            schema:(XSDschema*)schema
         minOccurs:(NSNumber*)minOccurs
         maxOccurs:(NSNumber*)maxOccurs {
  ...
  if (self) {
    ...
    if (_type == nil) {
      ...
      if (complexTypeNode != nil) {
        ...
        ((XSDcomplexType*)_localType).name =
        ...
        while (n != nil) {
          if ([XMLUtils node:(NSXMLElement*)n stringAttribute:@"name"]) {
            ((XSDcomplexType*)_localType).name = [NSString
                stringWithFormat:@"%@%@", [XMLUtils node:(NSXMLElement*)n stringAttribute:@"name"],
                                 ((XSDcomplexType*)_localType).name];
            break;
          }
          n = n.parent;
        ...
        if (simpleTypeNode != nil) {
          ...
          ((XSSimpleType*)_localType).name = [_name
          ...
          while (n != nil) {
            if ([XMLUtils node:(NSXMLElement*)n stringAttribute:@"name"]) {
              ((XSDcomplexType*)_localType).name = [NSString
                  stringWithFormat:@"%@%@",
                                   [XMLUtils node:(NSXMLElement*)n stringAttribute:@"name"],
                                   ((XSDcomplexType*)_localType).name];
              break;
            }
            n = n.parent;
...
- (void)updateNameAndTypeFromRef:(NSString*)ref {
  NSArray* allTypes =
      [self.schema.simpleTypes arrayByAddingObjectsFromArray:self.schema.complexTypes];
...
- (BOOL)hasComplexType {
  //    return (self.type != nil && [[self.schema typeForName:self.type]
  //    isKindOfClass:[XSDcomplexType class]]);
...
- (NSString*)readCodeForContent {
  ...
  if (self.localType != nil) {
    ...
    /* Fetch the type of the current element from the schema dictionaries and read the template code
     * and generate final code */
