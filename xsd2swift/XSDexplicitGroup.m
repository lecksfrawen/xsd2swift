 ...
 * Parameters:  (NSXMLElement *) - the current parent xml element (sequence or choice) containing
 * the elements (XSDschema *) - the current schema that this item is contain within Returns:     The
 * object that is generated that contains the child elements Description: Will define
 */
- (id)initWithNode:(NSXMLElement*)node schema:(XSDschema*)schema {
  ...
  if (self) {
    ...
    /* Grab the elements that are contained within this object and append them to the current
    ...
    for (NSXMLElement* anElement in elementTags) {
      ...
      [newElements addObject:[[XSDelement alloc] initWithNode:anElement
                                                       schema:schema
